...
Word 양식은 `templates/monthly-report-template.docx`에 둡니다. 양식을 교체할 때는 같은 파일명으로 덮어쓰되 `활동내용`, `제작물현황`, `차월계획`, 보고기간, 보고일, 보고자 위치는 유지해야 합니다. 선택한 보고 월이 `2026-07`이면 문서에는 `신천기 43(2026)년 7월분`, 보고일에는 `신천기 43(2026)년 7월 31일`이 입력되고 파일명은 `영상제작과_문화부_7월말보고서.docx`가 됩니다.
