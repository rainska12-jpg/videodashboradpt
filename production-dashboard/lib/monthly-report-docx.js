(function monthlyReportDocxModule(root, factory) {
  ...
  function paragraph(text, style = "Normal", bullet = false) {
    const numbering = bullet ? '<w:numPr><w:ilvl w:val="0"/><w:numId w:val="1"/></w:numPr>' : "";
  ...
  function createMonthlyReportDocx({ month, sections, organization = "", author = "" }) {
    ...
    const body = [
      ...
      ...sectionMeta.flatMap(([key, label]) => {
        ...
        return [paragraph(label, "Heading1"), ...(items.length ? items.map((item) => paragraph(item.text.trim(), "Normal", true)) : [paragraph("해당 없음", "Muted")])];
      })
    ].join("");
...
<w:styles xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:docDefaults><w:rPrDefault><w:rPr><w:rFonts w:ascii="Arial Unicode MS" w:hAnsi="Arial Unicode MS" w:eastAsia="Arial Unicode MS" w:cs="Arial Unicode MS"/><w:sz w:val="22"/><w:szCs w:val="22"/><w:color w:val="222222"/><w:lang w:val="ko-KR" w:eastAsia="ko-KR"/></w:rPr></w:rPrDefault><w:pPrDefault><w:pPr><w:spacing w:after="120" w:line="264" w:lineRule="auto"/></w:pPr></w:pPrDefault></w:docDefaults>
  <w:style w:type="paragraph" w:default="1" w:styleId="Normal"><w:name w:val="Normal"/><w:qFormat/><w:pPr><w:spacing w:after="120" w:line="264" w:lineRule="auto"/></w:pPr><w:rPr><w:rFonts w:ascii="Arial Unicode MS" w:hAnsi="Arial Unicode MS" w:eastAsia="Arial Unicode MS" w:cs="Arial Unicode MS"/><w:sz w:val="22"/></w:rPr></w:style>
